...
export const CircularTestimonials = ({
  ...
  return (
    <div className="w-full max-w-6xl mx-auto py-10 md:py-16">
      <div className="grid gap-12 md:grid-cols-2 md:gap-24 items-center">
        ...
        <div className="relative w-full h-[300px] md:h-[400px] [perspective:1000px]" ref={imageContainerRef}>
          {testimonials.map((testimonial, index) => (
            <img
              ...
              className="absolute w-full h-full object-cover rounded-3xl shadow-[0_10px_40px_rgba(0,0,0,0.15)]"
              data-index={index}
        ...
        <div className="flex flex-col justify-center h-full">
          ...
          <div className="flex gap-4 mt-12 md:mt-16">
            <button
              className="w-14 h-14 rounded-full flex items-center justify-center cursor-pointer transition-colors border-none"
              onClick={handlePrev}
              style={{
